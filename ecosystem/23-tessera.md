...
| **6** | One internal economy — spend and earn identically everywhere | **False** — [01](01-product-vision.md) §2 says it plainly: EMBER settles what is bought, but **no product earns it** | **True.** Tessera is the first surface in the estate where a user *earns*, and it earns EMBER, not scrip |
